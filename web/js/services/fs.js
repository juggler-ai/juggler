...
export class FileSystem {
   ...
   *   op so it runs in that conversation's bound workspace. '' ⇒ base.
   */
  constructor(allowedPaths = [], conversationId = '') {
     ...
     * it into that conversation's bound workspace (per-conversation
   ...
   * op runs in the conversation's bound workspace. No-op when unbound.
   * @template T
